...
directly ([[info:emacs#Invoking emacsclient][info "(emacs) Invoking emacsclient"]]),
so it is not necessary
# FIXME 2021-09-29 org-protocl.html was unavailable (404)
...
There is no requirement that executables should be in your PATH,
